...
def parse_config():
    ...
    parser.add_argument('--save_to_file', action='store_true', default='/mnt/sdb/public/data/hz/kitti/pcdet/test_output', help='')
...
def main():
    ...
    output_dir = cfg.ROOT_DIR / 'b1' / cfg.EXP_GROUP_PATH / cfg.TAG / args.extra_tag
    ...
    gpu_list = os.environ['CUDA_VISIBLE_DEVICES'] ='2'
