...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    print('---------------Start to generate data infos---------------',train_filename)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path=ROOT_DIR / 'mnt'/ 'sdb'/'public'/'data'/'hz'/'kitti'/'pcdet',
            save_path=ROOT_DIR / 'mnt'/ 'sdb'/'public'/'data'/'hz'/'kitti'/'pcdet'
        )
